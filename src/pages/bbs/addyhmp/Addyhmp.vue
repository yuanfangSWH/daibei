<template>
    <div class="content">
        ...
        <div class="addpage-box">
            <div class="add-title">添加文案</div>
            <ul class="add-ul">
                <li>
                   <span class="t-name">文案内容</span><Input maxlength="50" v-model="formItem.adddata"  type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入文案内容50字内" />
                </li>
                <li>
    ...
    methods: {
        addInform () {
            ...
            var data= qs.stringify({ 
                         id: this.formItem.id,
                         user_introduce: this.formItem.adddata,      
                });
