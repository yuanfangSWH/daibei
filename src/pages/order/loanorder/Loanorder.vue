        ...
        <div class="b-nr">
          <div class="tixdwz">
            <div class="blzbw">
              ...
              <div class="yhdmz">用户返佣：{{xuanzdshuj.order_yongjin_user}}</div>
              <div class="yhdmz3">
                <el-input
                  class="s-input2"
                  type="primary"
                  placeholder="请输入下款的金额...（必填）"
                  v-model="betData"
                  maxlength="11"
                  clearable
                ></el-input>
          ...
          <div class="b-anntes2">
            ...
            <el-button type="primary" v-show="state==1" @click="Dshenh(4)">订单转到待再查</el-button>
    ...
    <div class="list-div">
      ...
      <div class="l-nr-a">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          ...
          <div class="li" style="flex:2;">{{item.order_loan_name}}</div>
  ...
  methods: {
    ...
    conditionsData() {
      ...
      this.api.apiPost(
        ...
        (status, judge, res) => {
          if (status) {
            this.bankData = this.bankData.concat(res.data.allLoan);
          } else {
            this.$message({
              showClose: true,
              message: res.msg,
    ...
    Dshenh(value, data) {
      if (value == 1) {
        ...
        //判断下款金额是否为空
        if (this.betData == "" || this.betData == "null") {
          this.$message({
            showClose: true,
            message: "下款金额必填！",
            type: "error",
