    ...
    <div class="content">
        ...
        <div class="addpage-box">
            ...
            <ul class="add-ul">
                ...
                <li>
                    <span class="t-name">排序</span><input class="t-ipt" v-model="formItem.eduSort" type="text" placeholder="请输入教程名称" /><div class="demo-nav">必填</div>
                </li>
                <li>
                    <span class="t-name"></span><button class="t-btn" @click="addEdu">添加</button>
                </li>
            </ul>
        </div>
    </div>
