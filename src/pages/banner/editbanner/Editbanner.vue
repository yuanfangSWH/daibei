<template>
  <div class="content">
    ...
    <div class="addpage-box">
      ...
      <ul class="add-ul">
        <li>
          <span class="t-name">banner图片</span>
          <Upload
            ref="upload"
            :format="['jpg','jpeg','png']"
            :max-size="2048"
        ...
        <li>
          <span class="t-name">文字介绍</span>
          <input class="t-ipt" v-model="formItem.size" type="text" placeholder="请输入介绍" />
        </li>
        <li>
          <span class="t-name">跳转图片</span>
          <Upload
            ref="upload"
            :format="['jpg','jpeg','png']"
            :max-size="2048"
        ...
        <li>
          ...
          <input class="t-ipt" v-model="formItem.rank" type="text" placeholder="请输入排序" />
        </li>
        <li>
...
export default {
    ...
    this.api.apiPost(
      ...
      (status, code, res) => {
        if (code == 200) {
          ...
          this.formItem.imgurl1 = this.Infodata.poster_url;
          this.formItem.imgurl2 = this.Infodata.poster_value;
          this.formItem.size = this.Infodata.poster_text;
          this.formItem.rank = this.Infodata.post_losetime;
          this.formItem.id = this.Infodata.id;
        } else {
          console.log("获取数据失败");
        }
      }
  ...
  methods: {
    addBbs() {
      ...
      var data = qs.stringify({
        banner_id: this.formItem.id,
        value: {
          bannerBase64: this.formItem.imgurl1,
          bannerUrl: this.formItem.imgurl2,
