<template>
    <div class="content">
        ...
        <div class="addpage-box">
            ...
            <ul class="add-ul">
                <li>
                    <span class="t-name">banner图片</span><img-upload @func="getMsgFormSon"></img-upload>
                </li>
                <li>
                    <span class="t-name">文字介绍</span><input class="t-ipt" v-model="formItem.size" type="text" placeholder="请输入介绍" />
                </li>
                <li>
                    <span class="t-name">跳转图片</span><img-upload @func="getMsgFormSon2"></img-upload>
                </li>
                <li>
                    <span class="t-name">排序</span><input class="t-ipt" v-model="formItem.rank" type="text" placeholder="请输入排序" /><div class="demo-nav">必填</div>
                </li>
                <li>
