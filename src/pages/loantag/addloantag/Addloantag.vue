<template>
    <div class="content">
        <div class="addbtn"><router-link to="/Loantag"><button>返回</button></router-link></div>
        <div class="addpage-box">
            <div class="add-title">贷款产品标签添加</div>
            <ul class="add-ul">
                <li>
                ...
                <li>
                    <span class="t-name"></span><button class="t-btn" @click="addBanktag">添加</button>
                </li>
            </ul>
        </div>
    </div>
