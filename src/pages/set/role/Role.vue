<template>
    <div class="content">
        <!-- <div class="addbtn"><router-link to="/set/role/addrole"><button>添加账号</button></router-link></div> -->
        <div class="tabbox">
...
export default {
    ...
    methods: {
        getRoleList () {
            ...
            this.api.apiPost('/admin/role', 'get', '', params, (status, code, res) => {
                if (status) {
                    this.data1 = res.data;
