<template>
    <div class="content">
        ...
        <div class="addpage-box">
            ...
            <ul class="add-ul">
                <li>
                    <span class="t-name">等级名称</span><input class="t-ipt" v-model="url" type="text" placeholder="请输入等级名称" />
                </li>
                <li>
                    <span class="t-name">权限等级</span><input class="t-ipt" v-model="mshu" type="text" placeholder="请输入权限等级" />
                </li>
                <li>
    ...
    created () {
        ...
        this.api.apiPost('/admin/power', 'post', data, params, (status, code, res) => {
            if (status) {
                ...
                //console.log("接收："+JSON.stringify(this.powerdata));
                this.url = this.powerdata.af_url;
                this.mshu = this.powerdata.af_desc;
                this.model1 = this.powerdata.ap_id;
                this.id = this.powerdata.af_id;
            } else {
