<template>
    <div class="content">
        <div class="addbtn"><router-link to="/Addbanktag"><button>添加标签</button></router-link></div>
        <div class="tabbox">
            <Tabs :animated="false">
                <TabPane label="上架中">
        ...
        return{
            ...
            columns1: [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        render: (h, params) => {
                            //console.log("这里："+JSON.stringify(params.row))
                            return h('div', [
                                h('Button', {
                                    props: {
                                        type: 'primary',
